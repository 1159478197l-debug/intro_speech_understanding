...
def VAD(waveform, Fs):
    ...
    start_times = [ m*frameskip for m in range(VAD) if VAD[m-1]==0 and VAD[m]==1 ]
    end_times = [ m*frameskip for m in range(VAD) if VAD[m-1]==1 and VAD[m]==0 ]
